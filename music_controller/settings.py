...
SECRET_KEY = 'django-insecure-dftn0lsco2xvl@@wd0)=gjd4s1_x^n1+8#3r$6i5hpqp84s4^a'
...
CORS_ALLOW_ALL_ORIGINS = True  # For development; limit it in production to specific origins
CORS_ALLOW_METHODS = [
    'DELETE',
    'GET',
    'OPTIONS',
